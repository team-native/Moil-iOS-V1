...
struct GroupDetailView: View {
    ...
    private let members: [(String, String, Color)] = [("아빠", "관리자", MoilAvatarColor.blue), ("엄마", "멤버", MoilAvatarColor.red), ("나", "멤버", MoilAvatarColor.green), ("동생", "멤버", MoilAvatarColor.orange)]
    var body: some View {
        ScrollView(showsIndicators: false) { VStack(alignment: .leading, spacing: 0) {
            ...
            HStack(spacing: 12) {
                MoilAvatar(color: MoilAvatarColor.green, size: 48)
